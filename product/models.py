...
class Product(models.Model):
    ...
    description = models.CharField(max_length=500, null=True, blank=True, verbose_name="Краткое описание")
    add_info = models.CharField(max_length=500, null=True, blank=True, verbose_name="Полное описание")
